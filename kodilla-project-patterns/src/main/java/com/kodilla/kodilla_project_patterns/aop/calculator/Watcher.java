...
public class Watcher {
    ...
    @Before("execution(* com.kodilla.kodilla_project_patterns.aop.calculator.Calculator.factorial(..))" +
    ...
    @Around("execution(* com.kodilla.kodilla_project_patterns.aop.calculator.Calculator.factorial(..))")
